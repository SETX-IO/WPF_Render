...
namespace WPF_Render.SandBox
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            Dx9Renderer.POINT p = new Dx9Renderer.POINT(imgelt.PointToScreen(new Point(0, 0)));

            HRESULT.Check(Dx9Renderer.SetAdapter(p));
        }
        ...
        void SizeTimer_Tick(object sender, EventArgs e)
        {
            ...
            {
                HRESULT.Check(Dx9Renderer.SetSize(actualWidth, actualHeight));
            }
        }
