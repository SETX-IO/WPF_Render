...
public partial class MainWindow : Window, IDisposable
{
    ...
    void CompositionTarget_Rendering(object sender, EventArgs e)
    {
        ...
        if (d3dimg.IsFrontBufferAvailable && _lastRender != args.RenderingTime)
        {
            ...
            // HRESULT.Check(Dx9Renderer.GetBackBufferNoRef(out pSurface));
            _rendererManager.GetBackBufferNoRef(out var surface);
            ...
            if (surface is not null)
            {
                ...
                // HRESULT.Check(Dx9Renderer.Render());
    ...
    {
        _rendererManager = RendererManager.Create(this);

        // Set up the initial state for the D3DImage.
        _rendererManager.SetSize((uint)Width, (uint)Height);
        _rendererManager.SetAlpha(true);
        _rendererManager.SetNumDesiredSamples(4);
        // HRESULT.Check(Dx9Renderer.SetSize((uint)Width, (uint)Height));
        // HRESULT.Check(Dx9Renderer.SetAlpha(true));
        // HRESULT.Check(Dx9Renderer.SetNumDesiredSamples(4));
        ...
        _adapterTimer.Tick += (_, _) => _rendererManager.SetAdapter(imgelt.PointFromScreen(new Point(0, 0)));
        ...
        _sizeTimer.Tick += SizeTimer_Tick;
